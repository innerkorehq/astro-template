...
import type { ArticleBodyBlockData, ArticleBodyLink, ArticleBodyItem } from "@/components/utils/article-body/types";
...
function BlockLink({ link, className }: { link: ArticleBodyLink; className?: string }) {
...
function BlockItem({ item }: { item: ArticleBodyItem }) {
  return (
...
export function ArticleBodyDefault({ data, className }: ArticleBodyProps): React.ReactElement {
