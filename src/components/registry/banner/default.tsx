...
import type { BannerBlockData, BannerLink, BannerItem } from "@/components/utils/banner/types";

export interface BannerProps {
  readonly data: BannerBlockData;
...
function BlockLink({ link, className }: { link: BannerLink; className?: string }) {
...
function BlockItem({ item }: { item: BannerItem }) {
  return (
...
export function BannerDefault({ data, className }: BannerProps): React.ReactElement {
