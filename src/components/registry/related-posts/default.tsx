...
import type { RelatedPostsBlockData, RelatedPostsLink, RelatedPostsItem } from "@/components/utils/related-posts/types";

export interface RelatedPostsProps {
  readonly data: RelatedPostsBlockData;
...
function BlockLink({ link, className }: { link: RelatedPostsLink; className?: string }) {
...
function BlockItem({ item }: { item: RelatedPostsItem }) {
  return (
...
export function RelatedPostsDefault({ data, className }: RelatedPostsProps): React.ReactElement {
...
export default RelatedPostsDefault;
