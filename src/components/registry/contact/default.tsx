...
import type { ContactBlockData, ContactLink, ContactItem } from "@/components/utils/contact/types";

export interface ContactProps {
  readonly data: ContactBlockData;
...
function BlockLink({ link, className }: { link: ContactLink; className?: string }) {
...
function BlockItem({ item }: { item: ContactItem }) {
  return (
...
export function ContactDefault({ data, className }: ContactProps): React.ReactElement {
