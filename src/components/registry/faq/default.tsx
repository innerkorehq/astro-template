...
import type { FaqBlockData, FaqLink, FaqItem } from "@/components/utils/faq/types";

export interface FaqProps {
  readonly data: FaqBlockData;
...
function BlockLink({ link, className }: { link: FaqLink; className?: string }) {
...
function BlockItem({ item }: { item: FaqItem }) {
  return (
...
export function FaqDefault({ data, className }: FaqProps): React.ReactElement {
