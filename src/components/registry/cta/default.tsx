...
import type { CtaBlockData, CtaLink, CtaItem } from "@/components/utils/cta/types";

export interface CtaProps {
  readonly data: CtaBlockData;
...
function BlockLink({ link, className }: { link: CtaLink; className?: string }) {
...
function BlockItem({ item }: { item: CtaItem }) {
  return (
...
export function CtaDefault({ data, className }: CtaProps): React.ReactElement {
