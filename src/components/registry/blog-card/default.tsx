...
import type { BlogCardBlockData, BlogCardLink, BlogCardItem } from "@/components/utils/blog-card/types";

export interface BlogCardProps {
  readonly data: BlogCardBlockData;
...
function BlockLink({ link, className }: { link: BlogCardLink; className?: string }) {
...
function BlockItem({ item }: { item: BlogCardItem }) {
  return (
...
export function BlogCardDefault({ data, className }: BlogCardProps): React.ReactElement {
