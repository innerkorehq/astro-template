...
import type { MapBlockData, MapLink, MapItem } from "@/components/utils/map/types";
...
function BlockLink({ link, className }: { link: MapLink; className?: string }) {
...
function BlockItem({ item }: { item: MapItem }) {
  return (
...
export function MapDefault({ data, className }: MapProps): React.ReactElement {
