...
import type { FeatureBlockData, FeatureLink, FeatureItem } from "@/components/utils/feature/types";

export interface FeatureProps {
  readonly data: FeatureBlockData;
...
function BlockLink({ link, className }: { link: FeatureLink; className?: string }) {
...
function BlockItem({ item }: { item: FeatureItem }) {
  return (
...
export function FeatureDefault({ data, className }: FeatureProps): React.ReactElement {
