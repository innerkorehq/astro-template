...
import type { CommentBlockData, CommentLink, CommentItem } from "@/components/utils/comment/types";

export interface CommentProps {
  readonly data: CommentBlockData;
...
function BlockLink({ link, className }: { link: CommentLink; className?: string }) {
...
function BlockItem({ item }: { item: CommentItem }) {
  return (
...
export function CommentDefault({ data, className }: CommentProps): React.ReactElement {
