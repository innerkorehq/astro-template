...
import type { TestimonialBlockData, TestimonialLink, TestimonialItem } from "@/components/utils/testimonial/types";

export interface TestimonialProps {
  readonly data: TestimonialBlockData;
...
function BlockLink({ link, className }: { link: TestimonialLink; className?: string }) {
...
function BlockItem({ item }: { item: TestimonialItem }) {
  return (
...
export function TestimonialDefault({ data, className }: TestimonialProps): React.ReactElement {
