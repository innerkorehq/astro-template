...
import type { AnnouncementBlockData, AnnouncementLink, AnnouncementItem } from "@/components/utils/announcement/types";

export interface AnnouncementProps {
  readonly data: AnnouncementBlockData;
...
function BlockLink({ link, className }: { link: AnnouncementLink; className?: string }) {
...
function BlockItem({ item }: { item: AnnouncementItem }) {
  return (
...
export function AnnouncementDefault({ data, className }: AnnouncementProps): React.ReactElement {
...
export default AnnouncementDefault;
