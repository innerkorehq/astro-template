...
import type { TeamBlockData, TeamLink, TeamItem } from "@/components/utils/team/types";

export interface TeamProps {
  readonly data: TeamBlockData;
...
function BlockLink({ link, className }: { link: TeamLink; className?: string }) {
...
function BlockItem({ item }: { item: TeamItem }) {
  return (
...
export function TeamDefault({ data, className }: TeamProps): React.ReactElement {
