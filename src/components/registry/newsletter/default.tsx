...
import type { NewsletterBlockData, NewsletterLink, NewsletterItem } from "@/components/utils/newsletter/types";

export interface NewsletterProps {
  readonly data: NewsletterBlockData;
...
function BlockLink({ link, className }: { link: NewsletterLink; className?: string }) {
...
function BlockItem({ item }: { item: NewsletterItem }) {
  return (
...
export function NewsletterDefault({ data, className }: NewsletterProps): React.ReactElement {
